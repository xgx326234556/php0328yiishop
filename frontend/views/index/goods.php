                        ...
                        <div class="cat">
                            ...
                            <div class="cat_detail">
                                ...
                                foreach ($models as $model1){
                                    if($model1->parent_id==$model->id){?>
                                        <dl class="dl_1st">
                                        <dt><a href="/index/list/?id=<?=$model1->id?>"><?=$model1->name?></a></dt>
                                        <?php
                                        foreach ($models as $model2){
                                            if($model2->parent_id==$model1->id){?>

                                                <dd>
                                                    <a href="/index/list?id=<?=$model2->id?>"><?=$model2->name?></a>
                                                </dd>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                             <?php foreach ($goodgallery as $v):?>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://admin.yiishop.com<?=$v->path?>',largeimage: 'http://admin.yiishop.com<?=$v->path?>'}">
                                    <img src="http://admin.yiishop.com<?=$v->path?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="/index/add-to-cart" method="get" class="choose">
                    <ul>
        ...
        <div class="detail">
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            <li><span>商品名称:<?=$good->name?></span>ThinkPadX230(2306 3T4）</li>
                            <li><span>商品编号：</span><?=$good->sn?></li>
                            <li><span>品牌：</span><?=$brand->name?></li>
                        </ul>
                    </div>

                    <div class="desc mt10">
                        <?php foreach ($goodgallery as $v):?>
                        <?php echo  $good_intro->content    ?>
                        <img src="http://admin.yiishop.com<?=$v->path?>" alt="" />
